...
try {
  ...
  contactDetailsArray.push(new AddressBook("Vijay", "Kumar", "Manvi", "Raichur", "Karnataka", "421004",
    "91 7558368932", "bharambeakshay@gmail.com"));
  contactDetailsArray.push(new AddressBook("Arun", "Machnoor", "nearhighway", "Raichur", "Karnataka",
  ...
  console.log("****************************************************************");
  let index = contactDetailsArray.findIndex(contact => contact.firstName == "Arun");
